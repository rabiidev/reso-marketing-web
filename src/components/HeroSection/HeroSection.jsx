...
const HeroSection = () => {
  ...
  // const [showFourMenu, setShowFourMenu] = useState(false);
  // const [showFiveMenu, setShowFiveMenu] = useState(false);
  // const [showSixMenu, setShowSixMenu] = useState(false);
  // const [showSevenMenu, setShowSevenMenu] = useState(false);
  // const [showEightMenu, setShowEightMenu] = useState(false);
  // const [showNineMenu, setShowNineMenu] = useState(false);
  // const [showTenMenu, setShowTenMenu] = useState(false);
  // const [showElevenMenu, setShowElevenMenu] = useState(false);
  // const [showTwelveMenu, setShowTwelveMenu] = useState(false);


  // Function to toggle second menu visibility
  const handleFirstMenuClick = () => {
    setIsFirstMenuOpen(!isFirstMenuOpen);
  };
  // const handleSecondMenuClick = () => {
  //   setShowThirdMenu(!showSecondMenu);
  // };
  // const handleThirdMenuClick = () => {
  //   setShowFourMenu(!showSecondMenu);
  // };
  // const handleFourMenuClick = () => {
  //   setShowFiveMenu(!showSecondMenu);
  // };
  // const handleFiveMenuClick = () => {
  //   setShowSixMenu(!showSecondMenu);
  // };
  // const handleSixMenuClick = () => {
  //   setShowSevenMenu(!showSecondMenu);
  // };
  // const handleSevenMenuClick = () => {
  //   setShowEightMenu(!showSecondMenu);
  // };
  // const handleEightMenuClick = () => {
  //   setShowNineMenu(!showSecondMenu);
  // };
  // const handleNineMenuClick = () => {
  //   setShowTenMenu(!showSecondMenu);
  // };
  // const handleTenMenuClick = () => {
  //   setShowElevenMenu(!showSecondMenu);
  // };
  // const handleEelvenMenuClick = () => {
  //   setShowTwelveMenu(!showSecondMenu);
  // };
  ...
  return (
   ...
   <div className='d-flex'>
    <div className="sidebardiv ">
        <div className='categoriesdiv d-flex'>
        <svg className='ms-4 categoryicon' xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="white" d="M10 3H4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1m10 10h-6a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1M17 3c-2.206 0-4 1.794-4 4s1.794 4 4 4s4-1.794 4-4s-1.794-4-4-4M7 13c-2.206 0-4 1.794-4 4s1.794 4 4 4s4-1.794 4-4s-1.794-4-4-4"></path></svg>
            <p className='font-semibold text-white ps-2 mt-2'>All Categories</p>
        </div>
...
{/* {showThirdMenu && ( */}
    ...
    <Menu>
        <MenuButton classname='pe-4'>
          <span className='d-flex'>  
           <p>Electronics</p> 
        <svg className='' xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 1024 1024"><path fill="black" d="M338.752 104.704a64 64 0 0 0 0 90.496l316.8 316.8l-316.8 316.8a64 64 0 0 0 90.496 90.496l362.048-362.048a64 64 0 0 0 0-90.496L429.248 104.704a64 64 0 0 0-90.496 0"></path></svg>
        </span>
        </MenuButton>
      <MenuItems anchor="bottom">
      <MenuItem>
    ...
    <div className=''>
        <img src="/assets/hero-img1.jpg" alt="" className='heroimg pl-8  w-[0px] h-[334px] ' />
    </div>
    </div>
