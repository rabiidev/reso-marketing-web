  ...
  const onSubmit = async (e) => {
    ...
    try {
     ...
     if(!formData.cPassword) {
      ...
      const { data } = await axios.post('https://argetem-backend-server2.onrender.com/api/v1/user/signup', formData)
      console.log(data)
      if (!data.error) {
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <input
                ...
                ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6"
